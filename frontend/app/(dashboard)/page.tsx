            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-7">
                ...
                <Card className="col-span-4 border-none shadow-sm">
                    ...
                    <CardContent className="pl-6 pb-6">
                        ...
                        <div className="mt-4 flex h-[240px] items-end gap-3 sm:gap-6">
                            {[65, 45, 75, 55, 80, 70, 90, 60, 75, 85, 95, 80].map((h, i) => (
                                <div key={i} className="group relative flex w-full flex-col items-center gap-2">
                                    <div
                                        className="w-full rounded-t-lg bg-slate-100 transition-all duration-300 group-hover:bg-primary/20"
                                        style={{ height: `${h}%` }}
                                    >
                                        <div
                                            className={`absolute bottom-0 w-full rounded-t-lg bg-primary opacity-0 transition-opacity duration-500 group-hover:opacity-100`}
